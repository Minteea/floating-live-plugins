    ...
    let gift: LiveMessage.Gift = {
      ...
      info: {
        ...
        gift: {
          ...
          num: data.num,
          value:
            data.coin_type == "gold" ? data.total_coin / 100 : data.total_coin,
          valueType: data.coin_type,
          valueName: data.coin_type == "gold" ? "电池" : "银瓜子",
          price: data.coin_type == "gold" ? data.total_coin / 1000 : 0,
          currency: "CNY",
          action: data.action,
